  ...
  const useCases = [
    {
      ...
      champion: {
        ...
        title: "CISO",
        company: "Elastic",
        logoUrl: "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/521984105_elastic-search2066.jpg"
      }
    },
    {
      icon: Eye,
    ...
    },
    {
      ...
      champion: {
        ...
        title: "CISO",
        company: "SolarWinds",
        logoUrl: "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/8eb5fea29_images.png"
      }
    }
  ];
        ...
        <div className="text-center">
            ...
            <div className="grid grid-cols-3 gap-6 items-start">
                {useCases.map((useCase) => (
                    <div key={useCase.champion.name} className="bg-slate-50 rounded-xl p-5">
